...
var EventData = [
    ...
    description:"The relentless river that flows, untamed by mortal hands. It slips through our fingers, marking our past, present, and future. In its embrace, memories fade, moments are seized, and life's journey unfolds. Explore the ephemeral beauty and unyielding march of time in this mesmerizing 30-second reel."},
  {
    ...
    event_type_1: "Cultural",
    event_type_2: "Single",
    head_name_1: "Sandeep Suresh",
    head_phonenumber_1: "9567862431",
    head_name_2: "Mathew Paul",
    head_phonenumber_2: "8547423887",
    description:
  "hjasu"},
...

{
    ...
    head_phonenumber_1: "9544453174",
    head_name_2: "Aslam Salam",
    head_phonenumber_2: "6235608419",
    description:
  ...
  
{
    ...
    description:
"Get ready for the sensational YENME ECHOES competition at Samyuktha 7.0, where vocal virtuosos will shine! This individual event welcomes both undergraduate and postgraduate students to showcase their singing prowess. With a strict 5-minute time limit and the exclusion of accompanying instruments and microphones, it's all about the pure voice. Participants will enchant in two riveting rounds, starting with the classical/melody segment using karaoke in the preliminaries and then rocking the stage with fast beats songs of their choice in the finals. Spot registrations are allowed, but remember to share your music tracks in mp3 format at least 45 minutes before the rounds begin. The judges' decisions will ultimately crown the Best Singer of Samyuktha7.0!"  },
...

{
    ...
    description:
"Join us for an enchanting journey through your lens at the POLAROID PERSPECTIVES photography event. Unleash your creativity with mobile cameras, DSLRs, SLRs, or digital cameras to capture the eerie and mystical. Remember, in this competition, editing and filtering."  },
  ...
  
{
    ...
    event_type_1: "Technical",
    event_type_2: "Single",
    head_name_1: "Arjun J S",
    head_phonenumber_1: "6238745782",
    head_name_2: "Joseph Mel Joel",
    head_phonenumber_2: "9946899977",
    description:
  ...
  
{
    ...
    event_type_1: "Cultural",
    event_type_2: "Single",
    head_name_1: "Sarath S Nair",
    head_phonenumber_1: "7560911621",
    head_name_2: "Abel Mathew Abraham",
    head_phonenumber_2: "8129317480",
    description:
