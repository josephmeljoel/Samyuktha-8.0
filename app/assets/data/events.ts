...
var EventData = [
  ...
  },
  {
    ...
    rules: [
      ...
      " Participants can upload their videos on a drive and share the link of the drive in the mail id:",
      " Any Reel received after October--, will not be considered for the Competition.",
  ...
  },
  {
    ...
    rules: [
      "- Online registration closes on October 15th, 2024. There will be no spot registration available. ",
      "- Each team should have 5 players, with the option to include up to 2 substitutes. ",
      "- All team members must be from the same college and must present a valid college ID during the registration process. ",
      "- The first phase of the game will be held online in a knockout format. ",
      "- The semi-final and final rounds will be conducted offline as LAN events on  October 18th, 2024.",
      "- At least one team member must join the designated WhatsApp group for updates. ",
      "- Any rule violations, including disrespectful behaviour or cheating, will result in immediate disqualification.",
    ],
  },
  {
    id: 4,
